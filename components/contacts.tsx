...
export default function Contacts() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        setEmailInvalid(!formData.email);
        setMessageInvalid(!formData.message);
    ...
    return (
        <section id="contacts">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                {/* CTA box */}
                <div className="relative bg-orange-600 py-10 px-8 md:py-6 md:px-12" data-aos="fade-up">
                    ...
                    <div className="relative flex flex-col lg:flex-row justify-between items-center">
                        ...
                        {isSent && (<div className="w-100 mb-6 lg:mr-16 lg:mb-0 text-center lg:text-center">
                            <h3 className="h3 text-white mb-2">Greitu metu su Jumis susisieksime!</h3>
                        </div>)}

                        {!isSent && (<div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left lg:w-1/2">
                            <h3 className="h3 text-white mb-2">Susisiekite dabar!</h3>
                            <p className="text-orange-200 text-lg">Jūsų elektros rūpesčiams – nemokama
                                konsultacija!</p>
                        </div>)}

                        {!isSent && (<form onSubmit={handleSubmit} className="w-full lg:w-1/2">
                            <div>
                                <div className="flex flex-col sm:flex-col">
                                    <input
                                        ...
                                        className={`${isEmailInvalid && 'border-red-500'} w-full appearance-none bg-orange-700 border border-orange-500 focus:border-orange-300 rounded-sm px-4 py-3 mb-2 sm:mb-0 text-white placeholder-orange-400`}
                                        placeholder="Jūsų el. paštas..." aria-label="Your best email…"/>
                                    <textarea
                                        name="message"
                                        value={formData.message}
                                        onChange={handleChange}
                                        className={`${isMessageInvalid && 'border-red-500'} w-full mt-1 appearance-none bg-orange-700 border border-orange-500 focus:border-orange-300 rounded-sm px-4 py-3 mb-2 sm:mb-0 text-white placeholder-orange-400`}
                                        placeholder="Jūsų žinutė..." aria-label="Your message..."></textarea>
                                </div>
                                <div className="pt-6 flex justify-end">
                                    {isLoading
                                        ? <Loader/>
                                        : (<button className="btn text-orange-600 bg-orange-100 hover:bg-white shadow"
                                                   type="submit">Susisiekite
                                        </button>)}
                                </div>
                            </div>
                        </form>)}
