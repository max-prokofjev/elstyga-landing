                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="md:flex md:items-center md:justify-between">
                        ...
                        <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
                            <li className="ml-4">
                                <Link href="tel:+37068712334"
                                      className="flex justify-center items-center text-orange-600 bg-blue-800 hover:text-blue-100 hover:bg-orange-600 rounded-full transition duration-150 ease-in-out"
                                      aria-label="mobile-phone">
                                    <svg className="w-8 h-8 fill-current" viewBox="-8.4 -8.4 40.80 40.80"
                            ...
                            <li className="ml-4">
                                <Link href="mailto:info@elstyga.lt"
                                      className="flex justify-center items-center text-orange-600 bg-blue-800 hover:text-blue-100 hover:bg-orange-600 rounded-full transition duration-150 ease-in-out"
                                      aria-label="email">
                                    <svg className="w-8 h-8 fill-current" viewBox="-672 -672 3264.00 3264.00"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                        <g id="SVGRepo_tracerCarrier" strokeLinecap="round"
                                           strokeLinejoin="round"></g>
                            ...
                            <li className="ml-4">
                                <Link target="_blank" href="https://rekvizitai.vz.lt/imone/elstyga/"
                                      className="flex justify-center items-center text-orange-600 bg-blue-800 hover:text-blue-100 hover:bg-orange-600 rounded-full transition duration-150 ease-in-out"
                                      aria-label="rekvizitai">
                                    <svg className="w-8 h-8 fill-current" viewBox="-652.8 -652.8 3225.60 3225.60"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                        <g id="SVGRepo_tracerCarrier" strokeLinecap="round"
                                           strokeLinejoin="round"></g>
