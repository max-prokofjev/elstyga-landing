    ...
    <section className="relative bg-white pt-32 pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-8xl font-poppins font-bold text-blue-500 mb-4">404</h1>
          ...
          <Link
            href="/"
            className="btn text-white bg-blue-500 hover:bg-blue-600 rounded-lg px-6 py-3 inline-flex items-center"
          >
